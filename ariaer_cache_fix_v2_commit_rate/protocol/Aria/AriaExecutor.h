...
namespace aria
{
  ...
  public:
    ...
    void commit_transactions()
    {
      ...
      uint64_t local_batch_commit = 0, local_batch_abort = 0;
      ...
      n_batch_commit.fetch_add(local_batch_commit);
      n_batch_abort.fetch_add(local_batch_abort);
      n_batch_count.fetch_add(1);
    }
