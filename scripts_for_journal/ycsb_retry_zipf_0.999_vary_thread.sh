...
RESULTS_ROOT="${RESULTS_ROOT:-${ROOT}/result_for_journal/ycsb_retry_zipf_09_vary_thread}"
...
IFS=' ' read -r -a thread_counts <<< "${THREADS_LIST:-1 4 8 12 16 20 24 28 32 36 40 44 48 52 56 60}"
zipfs=(0.999)
ratios=(80 50)
ops_list=(10)
batch_sizes=(1000)
